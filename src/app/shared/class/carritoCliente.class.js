"use strict";
var producto_class_1 = require('./producto.class');
/**
...
var Carrito = (function () {
     ...
     */
    function Carrito(todosProductosArray, arrayPreciosParticulares, arrayDescuentosPorTipoCliente, tarifaCliente) {
        /**
         * ´prductos´ contiene productos indexados por su referencia.
         */
        this.productos = {};
        this.preciosArticuloParticular = {};
        this.descuentosFamilia = {};
        this.preciosPorTipoCLiente = {};
     ...
     * @param todosProductosArray  Array que contiene tdos los articulos disponibles.
     */
    Carrito.prototype.inicizalizarCarrito = function (todosProductosArray, arrayPreciosParticulares, arrayDescuentosPorTipoCliente, tarifaCliente) {
        var that = this;
        ...
        todosProductosArray.forEach(function (element, index) {
            that.productos[element.codart] = new producto_class_1.Producto(element.codart, element.articulo, that.definirPrecio(element.codart, element['preven' + tarifaCliente]));
        });
    };
    Carrito.prototype.inicializarEstructurasDePrecios = function (arrayPreciosParticulares, arrayDescuentosPorTipoCliente) {
        var that = this;
        var arrayPreciosArticuloParticular = arrayPreciosParticulares.filter(function (articulo, index) {
        ...
        var arrayDescuentosPorFamilia = arrayPreciosParticulares.filter(function (articulo, index) {
            return articulo.codfam != "";
        });
   ...
   */
    Carrito.prototype.definirPrecio = function (codArt, precioTarificado) {
